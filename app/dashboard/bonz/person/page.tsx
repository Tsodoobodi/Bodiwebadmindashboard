...
//   const [person, setPerson] = useState<PersonItem[]>([]);
...
//     try {
//       setLoading(true);
//       const res = await axios.get(`${API_URL}/api/person`);
//       const personData = res.data.data || res.data;

//       const formattedPerson = personData.map((item: PersonItem) => ({
//         ...item,
//         contents:
...
//       if (editId) {
//         const res = await axios.put(`${API_URL}/api/person/${editId}`, payload);
...
//         );
//       } else {
//         const res = await axios.post(`${API_URL}/api/person`, payload);
//         const newItem = res.data.data || res.data;
//         setPerson([{ ...newItem, contents: newContents }, ...person]);
//       }
